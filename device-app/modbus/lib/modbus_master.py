...
def send_modbus_request(tag,  modbus_response_deque, tcphandler):     
...
def recv_modbus_msg(modbus_tags, connection_status_tcp, slave_ip, polling_interval, modbus_response_deque, tcphandler):
    try:
        while True:
            for tag in modbus_tags:
                ...
                if tag["enable"] == True: 
                    if connection_status_tcp is True:
                        ...
                        send_modbus_request(tag,  modbus_response_deque, tcphandler)
